...
> **最后更新**：2026-07-17（V3.10 零宕机审查 8/8 修复 — 178 测试全绿）
...
| **管理端** | PC 后台 36 个模板页面（含 base.html）+ 32 页面级 CSS + 设计系统 Token (--accent: #5560cf) |
| **测试** | pytest (178 单元, 178/178 pass) + behave (138 场景, 970 步骤, 0 failed) + Ruff (0 errors) |
| **数据库** | MySQL 8.0, 49 张表 |
| **API** | 180 个端点 |
| **领域模块** | 26 个 |
| **定时任务** | 14 个 |
...
### 管理端页面目录（V3.8，共 36 个页面含 base.html）
