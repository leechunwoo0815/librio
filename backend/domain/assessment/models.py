...
class Assessment(BaseModel):
    ...
    teacher_id = Column(
        BigInteger, ForeignKey("teacher.id"), nullable=True, comment="评估老师ID"
    )
    venue_id = Column(
        BigInteger, ForeignKey("venue.id"), nullable=True, comment="场馆ID"
    )
    ...
    status = Column(
        ...
        default="pending",
        nullable=False,
        comment="状态: pending/completed/scheduled",
    )
