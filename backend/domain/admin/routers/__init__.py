...
from backend.domain.admin.routers.admin_advancement_router import (
    router as advancement_router,
)
from backend.domain.admin.routers.admin_activities_router import (
