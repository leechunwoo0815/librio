...
@when("用户尝试将第{count:d}本书加入书架")
def step_try_add_nth_book(context, count):
    book = Book(
        isbn=f"978NEW{count:04d}",
        title=f"NewBook{count}",
        author="Author",
        ar_value=2.0,
        age_min=5,
        age_max=9,
