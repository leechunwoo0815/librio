...
> **测试状态**: pytest 783 collected（通过数随环境：开发机 783 passed / CI 708+15 skip / 无 MySQL 沙箱 714+9 err）· behave 211/1369 · ruff 0 · API契约 OK · 模型一致 56 tables · CI 同构十一关（含 Gate 11）· 集成全绿 · alembic head=a5b6c7d8e9f0
...
> 项目终态交接-20260807.md》§一/§四为准**（pytest 783 / behave 211/1369 / 56 表 /
...
2. 运行 CI 同构十一关确认项目状态（pytest 783 collected，通过数随环境；behave 211/1369；ruff 0；api contract；model 56 tables；integration 全绿；alembic check；action wiring --strict；gen_config_doc --check）——权威基线与机制以《专家意见/项目终态交接-20260807.md》为准
3. 按剩余工作清单优先级开始：
