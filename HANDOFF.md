...
> 项目终态交接-20260807.md》§一/§四为准**（pytest 723 / behave 211/1369 / 56 表 /
...
2. 运行 CI 同构十一关确认项目状态（pytest 723 collected，通过数随环境；behave 211/1369；ruff 0；api contract；model 56 tables；integration 全绿；alembic check；action wiring --strict；gen_config_doc --check）——权威基线与机制以《专家意见/项目终态交接-20260807.md》为准
3. 按剩余工作清单优先级开始：
