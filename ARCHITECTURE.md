...
| 测试 | pytest (910 collected，通过数随环境) + behave (211 scenarios / 1369 steps) |
...
tests/unit/              # pytest 单元测试（910 个 collected，通过数随环境）
...
```bash
# pytest
910 collected（通过数随环境：开发机 910 passed / CI 708+15 skip / 无 MySQL 沙箱 714+9 err）
