...
| 测试 | pytest (708 collected，通过数随环境) + behave (211 scenarios / 1369 steps) |
...
tests/unit/              # pytest 单元测试（708 个 collected，通过数随环境）
...
```bash
# pytest
708 collected（通过数随环境：开发机 708 passed / CI 693+15 skip / 无 MySQL 沙箱 699+9 err）
