...
| 测试 | pytest (661 collected，通过数随环境) + behave (211 scenarios / 1368 steps) |
...
tests/unit/              # pytest 单元测试（661 个 collected，通过数随环境）
...
```bash
# pytest
661 collected（通过数随环境：开发机 661 passed / CI 646+15 skip / 无 MySQL 沙箱 652+9 err）
