...
| 测试 | pytest (700 collected，通过数随环境) + behave (211 scenarios / 1369 steps) |
...
tests/unit/              # pytest 单元测试（700 个 collected，通过数随环境）
...
```bash
# pytest
700 collected（通过数随环境：开发机 700 passed / CI 685+15 skip / 无 MySQL 沙箱 691+9 err）
