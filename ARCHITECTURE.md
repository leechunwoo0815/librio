...
| 测试 | pytest (702 collected，通过数随环境) + behave (211 scenarios / 1369 steps) |
...
tests/unit/              # pytest 单元测试（702 个 collected，通过数随环境）
...
```bash
# pytest
702 collected（通过数随环境：开发机 702 passed / CI 687+15 skip / 无 MySQL 沙箱 693+9 err）
