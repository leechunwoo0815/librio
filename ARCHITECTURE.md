...
| 测试 | pytest (601 collected，通过数随环境) + behave (211 scenarios / 1368 steps) |
...
tests/unit/              # pytest 单元测试（601 个 collected，通过数随环境）
...
```bash
# pytest
601 collected（通过数随环境：本机 596+5 skip / CI 586+15 skip / 无 MySQL 沙箱 592+9 err）
