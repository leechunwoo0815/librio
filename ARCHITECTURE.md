...
| 测试 | pytest (671 collected，通过数随环境) + behave (211 scenarios / 1369 steps) |
...
tests/unit/              # pytest 单元测试（671 个 collected，通过数随环境）
...
```bash
# pytest
671 collected（通过数随环境：开发机 671 passed / CI 656+15 skip / 无 MySQL 沙箱 662+9 err）
