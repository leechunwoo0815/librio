...
| 测试 | pytest (711 collected，通过数随环境) + behave (211 scenarios / 1369 steps) |
...
tests/unit/              # pytest 单元测试（711 个 collected，通过数随环境）
...
```bash
# pytest
711 collected（通过数随环境：开发机 711 passed / CI 696+15 skip / 无 MySQL 沙箱 702+9 err）
