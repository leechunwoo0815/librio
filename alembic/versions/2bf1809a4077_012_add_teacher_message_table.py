...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('msg_type', sa.SmallInteger(), nullable=True, comment='1=系统通知 2=活动通知 3=借阅通知 4=老师消息 5=阅读提醒'),
        sa.Column('priority', sa.SmallInteger(), nullable=True, comment='0=低 1=中 2=高'),
    ...
    op.create_index(op.f('ix_teacher_message_teacher_id'), 'teacher_message', ['teacher_id'], unique=False)
