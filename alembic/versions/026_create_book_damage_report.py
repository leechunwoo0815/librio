...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("borrow_record_id", sa.BigInteger(), nullable=False, index=True, comment="关联借阅记录ID"),
        sa.Column("book_copy_id", sa.BigInteger(), nullable=True, index=True, comment="关联副本ID"),
        sa.Column("child_id", sa.BigInteger(), nullable=False, index=True, comment="孩子ID"),
        sa.Column("damage_level", sa.SmallInteger(), nullable=False, comment="定级: 1=轻度免费 2=重度0.5×定价 3=丢失1.5×定价"),
        sa.Column("photo_url", sa.String(500), nullable=True, comment="损坏照片URL"),
        sa.Column("description", sa.Text(), nullable=True, comment="定责说明"),
        sa.Column("fine_amount", sa.Numeric(10, 2), nullable=True, comment="罚款金额（元）"),
        sa.Column("status", sa.SmallInteger(), nullable=True, comment="状态: 0=待申诉 1=已确认 2=申诉中 3=已冲正"),
        ...
        sa.Column("override_level", sa.SmallInteger(), nullable=True, comment="冲正后定级"),
        sa.Column("override_fine", sa.Numeric(10, 2), nullable=True, comment="冲正后罚款金额"),
        sa.Column("review_admin_id", sa.BigInteger(), nullable=True, comment="申诉/冲正审核管理员ID"),
