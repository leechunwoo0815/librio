...
def _drop_columns_safe():
    columns_to_drop = [
        ...
        ("deposit_record", "paid_at"),
        ("deposit_record", "refunded_at"),
        ("deposit_record", "deduction_reason"),
        ("bookshelf", "borrow_time"),
        ("bookshelf", "return_time"),
        ("favorites", "created_at"),
        ("learning_report", "total_words"),
        ("learning_report", "report_type"),
        ("learning_report", "suggestion"),
        ("learning_report", "voice_practices"),
        ("learning_report", "check_in_days"),
        ("learning_report", "total_minutes"),
...
def _add_back_columns():
    columns_to_add = [
        ...
        (
            "observation_report",
            "current_level",
            mysql.VARCHAR(charset="utf8mb4", collation="utf8mb4_unicode_ci", length=50),
            True,
        ),
