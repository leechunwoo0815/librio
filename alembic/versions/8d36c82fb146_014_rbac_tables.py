...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=32),
            nullable=False,
            comment="角色代码: super_admin / staff / teacher",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=64),
            nullable=False,
            comment="权限代码: group.action",
        ),
        sa.Column("name", sa.String(length=50), nullable=False, comment="权限名称"),
        sa.Column(
            "group_name", sa.String(length=32), nullable=False, comment="分组名称"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "permission_code", sa.String(length=64), nullable=False, comment="权限代码"
        ),
        sa.Column("create_time", sa.DateTime(), nullable=True, comment="创建时间"),
        sa.Column("update_time", sa.DateTime(), nullable=True, comment="更新时间"),
        sa.Column(
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.BigInteger(),
            nullable=True,
            comment="关联教师ID (role=teacher时必填)",
        ),
    )
